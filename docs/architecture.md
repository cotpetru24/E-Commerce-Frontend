...
Uses domain based route groupings (e.g., auth/products/cart/admin) with lazy loading to keep the bundle size manageable and ensure features remain isolated and scalable.
